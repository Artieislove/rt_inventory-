...
const CACHE_NAME = 'inventory-pwa-local-v2'; // Updated cache name to force service worker update
const urlsToCache = [
  './index.html', // Updated HTML filename
      ...
      .then(response => {
        ...
        return fetch(event.request).then(
          function(response) {
            ...
            // Cache the new resource if it's one of the core assets
